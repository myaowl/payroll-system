...
class PayslipPreviewDialog(QDialog):
    ...
    def __init__(self, payslip_data, emp_data, parent=None):
        ...
        btn_close.setStyleSheet("background:#4a9eff;color:#fff;border:none;border-radius:6px;padding:8px 20px;font-weight:bold;")
...
class PayslipGenerator(QWidget):
    ...
    def load_payslips(self):
        ...
        for row_data in rows:
            ...
            btn_view.setStyleSheet("background:#4a9eff30;color:#4a9eff;border:none;border-radius:4px;padding:4px 8px;")
